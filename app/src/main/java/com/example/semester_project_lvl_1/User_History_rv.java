...
public class User_History_rv extends RecyclerView.Adapter<User_History_rv.MyViewHolder> implements Filterable{
    List<order> ls;
    Context c;
    List<order> lsfull;
    public User_History_rv(List<order> ls, Context c) {
        this.c=c;
        this.ls=ls;
